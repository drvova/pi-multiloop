...
You have the pi-multiloop tools (multiloop_start, multiloop_iterate, multiloop_measure, multiloop_decide, multiloop_log, multiloop_resume, multiloop_pause, multiloop_stop, multiloop_archive, multiloop_compare, multiloop_send, multiloop_inbox, multiloop_publish, multiloop_results) plus the full local tool set (read, bash, edit, write, grep, find, ls). Loop state persists under .multiloop/ in the working directory and is shared with the parent session.
