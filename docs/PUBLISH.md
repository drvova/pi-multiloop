...
The tag push triggers `.github/workflows/publish.yml`. Watch it at https://github.com/drvova/pi-multiloop/actions.
...
- [ ] GitHub Releases page shows the new release: https://github.com/drvova/pi-multiloop/releases
